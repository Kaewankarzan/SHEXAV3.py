...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m BO ID ACTIVE KRDN @mr_shexa") 

      os.system('xdg-open  https://t.me/mr_shexa')
...
def menu(n,t):
	clear_layar()
	print(logo(n)+f'\n')
	print(f" [1]  CRACK PUPLICK")
	print(f" [2]  CRACK FILE")
	print(f" [3]  CRACK RANDOM")
	print(f" [4]  TELEGRAM")
	ask = input(f' [{hh}>>{P}] CHOOSE : ')
	print(' ─────────────────────────────')
	if ask in ['1','01']:crack_masal(t,c)
	elif ask in ['100','0100']:crack_masal5(t,c)
	elif ask in ['3','03']:crack_foll(t,c)
	elif ask in ['4','04']:os.system("xdg-open  https://t.me/u_69xi")
...
def atur_atur():
	...
	if apk in ['y','Y']:akunok.append('apk')
